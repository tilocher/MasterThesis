...
if __name__ == '__main__':
    ...
    ax_cons[2].plot(t_cons, rik.squeeze(), label='KF-inter', color=grey,linewidth=lineWidthPrimary,
             markersize=markerSize,
             linestyle='--')
    ax_cons[2].plot(t_cons, ae.squeeze(), label='AE-intra', color=yellow,linewidth=lineWidthPrimary,
             markersize=markerSize,
             linestyle='--')
    ...
    ax_cons[3].set_ylim(-1,1.3)


    plt.savefig('consecutiveResultsPhysioNet.pdf')
    plt.show()