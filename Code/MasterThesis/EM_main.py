...
if __name__ == '__main__':
    ...
    Logger = LocalLogger('EM_algorithm_test', BaseConfig= config)
    ...
    EM_Pipe = EM_Taylor_Pipeline(taylor_model,Logger, parameters= ['mu','Sigma','R','Q'])

    EM_Pipe.TrainTaylor(Train_Loader)

    EM_Pipe.Test(Test_Loader,10,q_2=np.random.random(),r_2=np.random.random())
